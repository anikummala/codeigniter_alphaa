		...
		<div class="container-fluid">
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
						<nav class="navbar navbar-default" role="navigation">
							<div class="container-fluid">
								...
								<button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-ex1-collapse">
									...
									<a class="navbar-brand" href="#">AniKummala</a>
								</div>
					...
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
						...
						<tr>
							<a href="<?php echo site_url('pegawai/create')?>" type="button" class="btn btn-info">Input Data</a>
						</tr>
							...
							<table class="table table-hover">
								...
								<?php foreach ($pegawai_list as $key) { ?>
									<tr>
										...
										<td>
											<a href="<?php echo site_url('pegawai/update/').$key->id ?>" type="button" class="btn btn-success">Edit</a>
											<a href="<?php echo site_url('pegawai/delete/').$key->id?>" type="button" class="btn btn-danger">Hapus</a>
										</td>
									</tr>
								<?php } ?>
